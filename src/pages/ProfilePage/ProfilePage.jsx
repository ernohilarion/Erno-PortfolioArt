        ...
        <div className="userProfile mb-5">
            <div className="image-container">
                <div className='backgrdBlockone'
                    ...
                    <div className="textOverlayBlockone collection-backgrd-text">
                        <h1 className="marquee-container">{userData?.username} {userData?.artist}</h1>
                    </div>
                    <div>
                ...
                {isLoading ? (
                    ...
                    <>
                        <div className='collection-profile'>
                            <h3>{userData?.username} {userData?.artist}</h3>
