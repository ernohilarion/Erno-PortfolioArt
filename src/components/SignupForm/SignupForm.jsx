                    ...
                    <>
                        <Form onSubmit={handleFormSubmit}>
                            ...
                            <Form.Group className="mb-3" controlId="artist">
                                ...
                                <Form.Control type="text" value={signupData.artist} onChange={handleInputChange} name="artist" />
                            </Form.Group>
                            ...
                            <Form.Group className="mb-3" controlId="year">
                                ...
                                <Form.Control type="text" value={signupData.year} onChange={handleInputChange} name="year" />
                            </Form.Group>
